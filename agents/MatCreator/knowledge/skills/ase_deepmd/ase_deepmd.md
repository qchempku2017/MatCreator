...
name: ase_deepmd
description: >
  Skills for running ASE molecular dynamics (MD) and structure optimisation
  using a DeePMD interatomic potential — input preparation, remote batch
  submission to Bohrium, and result collection.
tags: [ase, deepmd, md, molecular-dynamics, structure-optimisation, bohrium]
